...
public final class FulfillmentProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "1google/cloud/dialogflow/v2beta1/fulfillment.proto\022\037google.cloud.dialogflow.v2b"
          ...
          + ">.google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebServiceH\000\022\017\n"
          + "\007enabled\030\004 \001(\010\022F\n"
          + "\010features\030\005"
          + " \003(\01324.google.cloud.dialogflow.v2beta1.Fulfillment.Feature\032\217\002\n"
          + "\021GenericWebService\022\020\n"
          + "\003uri\030\001 \001(\tB\003\340A\002\022\020\n"
          + "\010username\030\002 \001(\t\022\020\n"
          + "\010password\030\003 \001(\t\022k\n"
          + "\017request_headers\030\004 \003(\0132R.google.cloud.dialogflo"
          + "w.v2beta1.Fulfillment.GenericWebService.RequestHeadersEntry\022 \n"
          ...
          + "\007Feature\022G\n"
          + "\004type\030\001"
          + " \001(\01629.google.cloud.dialogflow.v2beta1.Fulfillment.Feature.Type\"+\n"
          + "\004Type\022\024\n"
          ...
          + "%dialogflow.googleapis.com/Fulfillment\"\230\001\n"
          + "\030UpdateFulfillmentRequest\022F\n"
          + "\013fulfillment\030\001"
          + " \001(\0132,.google.cloud.dialogflow.v2beta1.FulfillmentB\003\340A\002\0224\n"
          + "\013update_mask\030\002"
          + " \001(\0132\032.google.protobuf.FieldMaskB\003\340A\0022\271\005\n"
          + "\014Fulfillments\022\357\001\n"
          + "\016GetFulfillment\0226.google.cloud.dialogflow.v2beta1.GetFulfillmen"
          ...
          + "/{name=projects/*/locations/*/agent/fulfillment}\332A\004name\022\274\002\n"
          + "\021UpdateFulfillment\0229.google.cloud.dialogflow.v2beta1.UpdateFu"
          + "lfillmentRequest\032,.google.cloud.dialogfl"
          + "ow.v2beta1.Fulfillment\"\275\001\202\323\344\223\002\234\00128/v2bet"
          + "a1/{fulfillment.name=projects/*/agent/fulfillment}:\013fulfillmentZS2D/v2beta1/{ful"
          ...
          + "loud-platform,https://www.googleapis.com/auth/dialogflowB\256\001\n"
          + "#com.google.cloud.dialogflow.v2beta1B\020FulfillmentProtoP\001ZIgo"
          + "ogle.golang.org/genproto/googleapis/clou"
          + "d/dialogflow/v2beta1;dialogflow\370\001\001\242\002\002DF\252"
          + "\002\037Google.Cloud.Dialogflow.V2beta1b\006proto3"
    };
    descriptor =
