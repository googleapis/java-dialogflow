...
public final class SessionProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "-google/cloud/dialogflow/v2beta1/session.proto\022\037google.cloud.dialogflow.v2beta1"
          + "\032\034google/api/annotations.proto\032\027google/a"
          + "pi/client.proto\032\037google/api/field_behavi"
          + "or.proto\032\031google/api/resource.proto\032+goo"
          + "gle/cloud/dialogflow/v2beta1/agent.proto\0322google/cloud/dialogflow/v2beta1/audio_"
          + "config.proto\032-google/cloud/dialogflow/v2beta1/context.proto\032)google/cloud/dialog"
          + "flow/v2beta1/gcs.proto\032,google/cloud/dialogflow/v2beta1/intent.proto\0329google/clo"
          + "ud/dialogflow/v2beta1/session_entity_typ"
          + "e.proto\032\036google/protobuf/duration.proto\032"
          + " google/protobuf/field_mask.proto\032\034google/protobuf/struct.proto\032\027google/rpc/status.proto\032\030google/type/latlng.proto\"\204\003\n"
          + "\023DetectIntentRequest\022:\n"
          + "\007session\030\001 \001(\tB)\340A\002\372A#\n"
          + "!dialogflow.googleapis.com/Session\022F\n"
          + "\014query_params\030\002"
          + " \001(\01320.google.cloud.dialogflow.v2beta1.QueryParameters\022E\n"
          + "\013query_input\030\003"
          + " \001(\0132+.google.cloud.dialogflow.v2beta1.QueryInputB\003\340A\002\022O\n"
          ...
          + " \001(\0132,.google.cloud.dialogflow.v2beta1.QueryResult\022O\n"
          + "\031alternative_query_results\030\005"
          + " \003(\0132,.google.cloud.dialogflow.v2beta1.QueryResult\022*\n"
          ...
          + " \001(\01322.google.cloud.dialogflow.v2beta1.OutputAudioConfig\"\376\004\n"
          ...
          + " \003(\01322.google.cloud.dialogflow.v2beta1.SessionEntityType\022(\n"
          ...
          + " \001(\0132?.google.cloud.dialogflow.v2beta1.SentimentAnalysisRequestConfig\022=\n\n"
          + "sub_agents\030\r"
          + " \003(\0132).google.cloud.dialogflow.v2beta1.SubAgent\022]\n"
          + "\017webhook_headers\030\016"
          + " \003(\0132D.google.cloud.dialogflow.v2beta1.QueryParameters.WebhookHeadersEntry\0325\n"
          + "\023WebhookHeadersEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"\240\002\n\n"
          + "QueryInput\022I\n"
          + "\014audio_config\030\001"
          + " \001(\01321.google.cloud.dialogflow.v2beta1.InputAudioConfigH\000\022:\n"
          ...
          + "\004dtmf\030\004"
          + " \001(\01324.google.cloud.dialogflow.v2beta1.TelephonyDtmfEventsH\000B\007\n"
          + "\005input\"\220\006\n"
          ...
          + " \001(\01328.google.cloud.dialogflow.v2beta1.SentimentAnalysisResult\022L\n"
          + "\021knowledge_answers\030\022"
          + " \001(\01321.google.cloud.dialogflow.v2beta1.KnowledgeAnswers\"\257\003\n"
          + "\020KnowledgeAnswers\022I\n"
          + "\007answers\030\001"
          + " \003(\01328.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer\032\317\002\n"
          + "\006Answer\0227\n"
          ...
          + "\026match_confidence_level\030\004"
          + " \001(\0162M.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel\022\030\n"
          ...
          + " \001(\01320.google.cloud.dialogflow.v2beta1.QueryParameters\022E\n"
          + "\013query_input\030\003"
          + " \001(\0132+.google.cloud.dialogflow.v2beta1.QueryInputB\003\340A\002\022\034\n"
          ...
          + " \001(\0132;.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult\022B\n"
          + "\014query_result\030\003"
          + " \001(\0132,.google.cloud.dialogflow.v2beta1.QueryResult\022O\n"
          + "\031alternative_query_results\030\007"
          + " \003(\0132,.google.cloud.dialogflow.v2beta1.QueryResult\022*\n"
          + "\016webhook_status\030\004 \001(\0132\022.google.rpc.Status\022\024\n"
          + "\014output_audio\030\005 \001(\014\022O\n"
          + "\023output_audio_config\030\006"
          + " \001(\01322.google.cloud.dialogflow.v2beta1.OutputAudioConfig\"\260\004\n"
          + "\032StreamingRecognitionResult\022]\n"
          + "\014message_type\030\001"
          + " \001(\0162G.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType\022\022\n\n"
          ...
          + " \003(\0132/.google.cloud.dialogflow.v2beta1.SpeechWordInfo\0224\n"
          + "\021speech_end_offset\030\010 \001(\0132\031.google.protobuf.Duration\022\025\n\r"
          + "language_code\030\n"
          + " \001(\t\022I\n"
          + "\013dtmf_digits\030\005"
          + " \001(\01324.google.cloud.dialogflow.v2beta1.TelephonyDtmfEvents\"\202\001\n"
          ...
          + " \001(\0132*.google.cloud.dialogflow.v2beta1.Sentiment\"-\n"
          + "\tSentiment\022\r\n"
          + "\005score\030\001 \001(\002\022\021\n"
          + "\tmagnitude\030\002 \001(\0022\215\006\n"
          + "\010Sessions\022\347\003\n"
          + "\014DetectIntent\0224.google.cloud.dialogflow.v2beta1.DetectIntentRequ"
          + "est\0325.google.cloud.dialogflow.v2beta1.De"
          + "tectIntentResponse\"\351\002\202\323\344\223\002\314\002\";/v2beta1/{"
          + "session=projects/*/agent/sessions/*}:detectIntent:\001*ZW\"R/v2beta1/{session=projec"
          + "ts/*/agent/environments/*/users/*/sessions/*}:detectIntent:\001*ZL\"G/v2beta1/{sessi"
          + "on=projects/*/locations/*/agent/sessions/*}:detectIntent:\001*Zc\"^/v2beta1/{session=projects/*/locations/*/agent/environments/*/users/*/sessions/*}:detectIntent:\001*\332A\023session,query_input\022\234\001\n"
          + "\025StreamingDetectIntent\022=.google.cloud.dialogflow.v2bet"
          + "a1.StreamingDetectIntentRequest\032>.google.cloud.dialogflow.v2beta1.StreamingDetec"
          + "tIntentResponse\"\000(\0010\001\032x\312A\031dialogflow.googleapis.com\322AYhttps://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\377\003\n"
          + "#com.google.cloud.dialogflow.v2beta1B\014SessionProtoP\001Z"
          + "Igoogle.golang.org/genproto/googleapis/cloud/dialogflow/v2beta1;dialogflow\370\001\001\242\002\002DF\252\002\037Google.Cloud.Dialogflow.V2beta1\352A\321\002\n"
          + "!dialogflow.googleapis.com/Session\022+projects/{project}/agent/sessions/{session}"
          + "\022Sprojects/{project}/agent/environments/{environment}/users/{user}/sessions/{ses"
          + "sion}\022@projects/{project}/locations/{location}/agent/sessions/{session}\022hproject"
          + "s/{project}/locations/{location}/agent/environments/{environment}/users/{user}/s"
